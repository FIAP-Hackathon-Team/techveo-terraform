# TechVeo Terraform Project

Este projeto cria a infraestrutura AWS para o TechVeo usando Terraform, incluindo um cluster EKS e toda a infraestrutura necessária.
...
```powershell
cd "c:\Projetos\techveo-terraform"
```
...
aws eks describe-cluster --name techveo-eks --region us-east-1
```
